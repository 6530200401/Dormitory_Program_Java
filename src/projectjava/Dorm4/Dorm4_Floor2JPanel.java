 ...
 * @author User
 */
public class Dorm4_Floor2JPanel extends javax.swing.JPanel {

    /**
     * Creates new form Dorm4_Floor2JPanel
     */
    Profile pr;
    public Dorm4_Floor2JPanel(Profile oldpr,String dorm) {
        initComponents();
        javax.swing.JLabel[] color_room = {room1,room2,room3,room4,room5,room6,room7,room8,room9};
        pr = oldpr;
        pr.setColor(color_room,dorm);
    }
    public Dorm4_Floor2JPanel() {
        initComponents();
    }
