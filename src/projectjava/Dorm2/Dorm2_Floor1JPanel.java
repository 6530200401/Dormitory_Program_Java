 ...
 * @author User
 */
public class Dorm2_Floor1JPanel extends javax.swing.JPanel {

    /**
     * Creates new form Dorm2_Floor1JPanel
     */
    Profile pr;
    public Dorm2_Floor1JPanel(Profile oldpr,String dorm) {
        initComponents();
        javax.swing.JLabel[] color_room = {room1,room2,room3,room4,room5,room6,room7,room8,room9};
        pr = oldpr;
        pr.setColor(color_room,dorm);
    }
    public Dorm2_Floor1JPanel() {
        initComponents();
    }
